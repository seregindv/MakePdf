...
namespace MakePdf.Controls.Buttons
{
    /// <summary>
    ...
    {
        public static readonly DependencyProperty MenuItemSourceProperty =
            DependencyProperty.Register("ButtonMenuItemsSource", typeof(IList), typeof(SplitButton), new PropertyMetadata(default(IList)));
        public IList ButtonMenuItemsSource
        {
        ...
        public static readonly DependencyProperty MenuItemStyleProperty =
            DependencyProperty.Register("MenuItemStyle", typeof(Style), typeof(SplitButton), new PropertyMetadata(default(Style)));
        ...
        //{
        //    get { return _buttonMenuItemsSource; }
        //}
        ...
        {
            if ((0 < ButtonMenuItemsSource.Count) && (null != _contextMenu))
            {
